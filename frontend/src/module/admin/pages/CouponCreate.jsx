        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex items-center justify-between gap-4 mb-6">
            ...
            <button
              ...
              className="px-4 py-2.5 text-sm font-medium rounded-lg bg-orange-500 text-white hover:bg-orange-600 flex items-center gap-2 transition-all shadow-sm whitespace-nowrap"
            >
              <X className="w-4 h-4" />
              Close
            </button>
          ...
          >
            <div className="rounded-xl border border-slate-200 bg-white p-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-sm rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="50"
                      className="w-full pl-10 pr-4 py-3 text-sm rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500"
                    />
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pr-12 px-4 py-3 text-sm rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500"
                    />
                        ...
                        filteredRestaurants.map((restaurant) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              />
                              <span className={`text-sm font-medium ${isSelected ? "text-orange-900" : "text-slate-700"} capitalize`}>
                                {restaurant}
                              </span>
                            </label>
                          )
              ...
              <div className="mt-8 flex items-center justify-end gap-3 pt-6 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="px-8 py-3 text-sm font-semibold rounded-xl bg-orange-600 text-white hover:bg-orange-700 transition-all shadow-md shadow-orange-200 active:scale-95 flex items-center gap-2"
                >
