          ...
          <div className="space-y-3">
            {trips.map((trip) => (
              <div
                ...
                onClick={() => navigate(`/delivery/order/${trip.id || trip.orderId}`)}
                className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow active:bg-gray-50 cursor-pointer"
              >
